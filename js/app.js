...
function getMovies(searchQuery){
    axios.get(`http://www.omdbapi.com/?apikey=${API_KEY}&s=${searchQuery}`)
    .then((response) => {
...
function getMovie(){
    ...
    .then((response) => {
        ...
        let output = `
            ...
            <div class="row">
                <div class="well">
                    <h3 style="margin-top: 1rem">Plot</h3>

                    ${movie.Plot}

                    <hr />

                    <a href="http://www.imdb.com/title/${movie.imdbID}" target="_blank" class="btn btn-primary">
                        View IMDB
                    </a>
